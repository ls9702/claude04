...
작성일: 2026-09-25 · 상태: **v0.4 확정 — P0 착수** · 결정 이력은 §10
...
| 09-25 | **v0.4 확정.** 라이브 보정은 필수(P5 유지). 무료 Apple ID 7일 갱신 방식 적용. 실행 순서는 §8대로(쇼츠 먼저) |

## 11. 다음 행동
1. ~~v0.4 확정~~ 완료.
2. **P0 진행 중**: 프로젝트 골격 커밋 → 사용자가 `docs/MAC_SETUP.md`대로 Mac에서 빌드·설치 → 결과(성공 또는 오류 로그) 공유.
